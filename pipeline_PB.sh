...
~/marco/pipeline/process_PB.pl $FNA $BASE $BASE $BASE $MKDB > $BASE.tsv 2> $BASE.log
...
~/marco/pipeline/export_nogenes.pl $BASE insert.db 0 10000 50 SPLINK > $BASE.export.txt
